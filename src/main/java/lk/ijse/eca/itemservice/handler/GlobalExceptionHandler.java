package lk.ijse.eca.itemservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleItemNotFound(
        ...
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.NOT_FOUND, "Item Not Found", ex.getMessage(), request.getRequestURI());
        return problemResponse(HttpStatus.NOT_FOUND, problem);
    }

    @ExceptionHandler(DuplicateItemException.class)
    public ResponseEntity<ProblemDetail> handleDuplicateItem(
            DuplicateItemException ex, HttpServletRequest request) {
        log.warn("Duplicate item: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.CONFLICT, "Duplicate Item", ex.getMessage(), request.getRequestURI());
